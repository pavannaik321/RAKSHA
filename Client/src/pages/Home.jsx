  ...
  return (
    <div className='flex justify-center '>
      ...
      <div className='mr-5 rounded-lg shadow-2xl w-56 h-52 flex flex-col pt-4 items-center mb-16'>
        ...
        <button className='m-5 px-2 py-1 bg-red-500 text-white rounded-md'>Emergency</button>
      </div>
      <div className='rounded-lg shadow-2xl w-56 h-52 flex flex-col pt-4 items-center'>
        {/* regester or login with doctor image */}
      <img className='b-10 rounded-full' width={80} src={doctor} alt="" /> 
      <div className='m-5 flex flex-col' >
        <button onClick={()=>{
          navigate('/login')
        }}  className='px-2 py-1 bg-blue-500 text-white rounded-md'>Login</button>
        <button onClick={()=>{
          navigate('/register')
        }} className='m-2 px-4 py-1 bg-blue-500 text-white rounded-md'>register</button>
      </div>
